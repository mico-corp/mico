...
```
sudo apt install -y git cmake qt5-default qtmultimedia5-dev libeigen3-dev libboost-all-dev libpcl-dev freeglut3-dev libgraphviz-dev # Common dependencies
