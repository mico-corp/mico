...
//
//  All information contained herein is, and remains the property of Vertical
//  Engineering Solutions.  The intellectual and technical concepts contained
//  herein are proprietary to Vertical Engineering Solutions and its suppliers
//  and may be covered by UE and Foreign Patents, patents in process, and are
//  protected by trade secret or copyright law. Dissemination of this
//  information or reproduction of this material is strictly forbidden unless
//  prior written permission is obtained from Vertical Engineering Solutions.
//
//-----------------------------------------------------------------------------
//
...
public:
  ...
  void setAntiWindup(AntiWindupMethod _antiWindup,
  ...
  /// \param _accumulative: magnitude to be written. If negative, value is
  /// ignored. \param _isOutputScale: if true, the _accumulative term will be
  /// divided by Ki to scale it. If false, the value is set as given.
  ...
  void ki(float _ki) {
    if (_ki != 0.0f) {
      // Scale accumulated error to prevent abrupt changes in integral component
      // of control signal
      accumErr_ *= ki_ / _ki;
    }
    ki_ = _ki;
